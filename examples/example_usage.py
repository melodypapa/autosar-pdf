"""
Example file: Demonstrates how to use the pdf2txt library
"""
from pdf2txt import (
    convert_pdf_to_text,
    convert_to_markdown,
...
def example_usage():
    ...
    print("\nExample 2: Convert using different methods")
    print("convert_pdf_to_text('example.pdf', method='pdfplumber')  # Use pdfplumber as backend")
    ...
    print(")")
    print("# Return value: Dictionary containing text, page count statistics, and image information")
    
    # Example 4: Get PDF information
    print("\nExample 4: Get PDF file information")
    print("info = get_pdf_info('example.pdf')")
    print("# Return value: Dictionary containing file size, page count, metadata, and other information")
    
    # Example 5: Convert to markdown format
    print("\nExample 5: Convert to markdown format")
    print("text = convert_pdf_to_text('example.pdf', skip_header_lines=3, skip_footer_lines=2)")
    ...
    print("# Return value: Text with control characters and special symbols removed/replaced")
    
    # Example 7: Extract tables from PDF
    print("\nExample 7: Extract tables from PDF")
    print("tables = extract_tables_from_pdf('example.pdf')")
    print("# Return value: List of tables with metadata (page, table data, row count, col count)")
